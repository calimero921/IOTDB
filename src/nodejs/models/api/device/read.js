...
module.exports = function (data) {
    ...
    if (typeof data !== 'undefined') {
        ...
        if (typeof data.device_creation_date !== 'undefined') result.device_creation_date = data.device_creation_date.toString();
        ...
        if (typeof data.device_last_connexion_date !== 'undefined') result.device_last_connexion_date = data.device_last_connexion_date.toString();
    }
